...
{
    [CustomEditor(typeof(VirtualListBar), true)]
    [CanEditMultipleObjects]
    public class VirtualListBarEditor : SelectableEditor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (m_HandleRect.objectReferenceValue != null)
            {
                ...
                if (EditorGUI.EndChangeCheck())
                {
                    VirtualListBar.Direction direction = (VirtualListBar.Direction)m_Direction.enumValueIndex;
                    foreach (var obj in serializedObject.targetObjects)
                    {
                        VirtualListBar scrollbar = obj as VirtualListBar;
                ...
                {
                    VirtualListBar scrollbar = obj as VirtualListBar;
                    VirtualListBar.Direction dir = scrollbar.direction;
                    if (dir == VirtualListBar.Direction.LeftToRight || dir == VirtualListBar.Direction.RightToLeft)
