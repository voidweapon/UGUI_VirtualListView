...
{
    public static class VirtualListViewControls
    {
        ...
        public static GameObject CreateVirtualListView(DefaultControls.Resources resources)
        {
            GameObject root = CreateUIElementRoot("Virtual List View", new Vector2(200, 200));
            ...
            VirtualListView scrollRect = root.AddComponent<VirtualListView>();
            ...
            scrollRect.ScrollType = VirtualListView.ListScrollType.Vertical;
